...
// Pinos do TTP224
#define TOUCH_PIN_1 6 // TTP224 pino 1
#define TOUCH_PIN_2 7 // TTP224 pino 2
#define TOUCH_PIN_3 8 // TTP224 pino 3
#define TOUCH_PIN_4 10 // TTP224 pino 4

Adafruit_SH1106 display(OLED_RESET);
MFRC522 mfrc522(SS_PIN, RST_PIN);

byte targetUID[] = {0xE6, 0xC2, 0x66, 0xAC}; // UID da tag
